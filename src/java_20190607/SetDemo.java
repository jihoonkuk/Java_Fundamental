...
public class SetDemo {
	public static void main(String[] args) {
		...
		//HashSet-데이터(객체)의 중복을 허용하지않고, 순서 없음
		/*HashSet set1 = new HashSet();*/
		
		//TreeSet은 데이터의 중복을 허용하지 않고, natural ordering (오름차순정렬)
		/*TreeSet<String> set1 = new TreeSet<String>();*/
		
		//LinkedHashSet은 데이터의 중복을 허용하지 않고, FIFO
...
class Customer{
	...
	//generate constructor using Field 와 generate setter and getter
/*	public Customer(String name, int age) {
		super();
		this.name = name;
		this.age = age;
